...
var codegarageApp = angular.module('codegarageApp',['ngRoute','ngSanitize','ngResource','ngAnimate','ngTagsInput','ngSocial','autocomplete','ipCookie','ui.markdown','SnippetContollers','snippetServices']);
