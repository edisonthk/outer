...
$id = DB::table('snippet_table')->insertGetId(array('title'=>'Checking Katagana','created_at'=>'2014-07-05 16:47:21','updated_at'=>'2014-08-29 19:46:29','content'=>'Regex version\n    ^[ァ-ヶー]+$\n\nFull version\n    mb_regex_encoding(&quot;UTF-8&quot;);\n    if (preg_match(&quot;/^[ぁ-ん]+$/u&quot;, $string)) {\n        echo &quot;ひらがなのみ&quot;;\n    }\n    if (preg_match(&quot;/^[ァ-ヶー]+$/u&quot;, $string)) {\n        echo &quot;カタカナのみ&quot;;\n    }'));
DB::table('snippet_tag')->insert(array('tag_id'=>3,'snippet_id'=>$id,'created_at'=>'2014-07-05 16:47:21','updated_at'=>'2014-08-29 19:46:29'));

$id = DB::table('snippet_table')->insertGetId(array('title'=>'PDO configure database','created_at'=>'2014-08-28 15:20:28','updated_at'=>'2014-08-28 15:20:35','content'=>'These variables define the connection information for your MySQL database\n\n    $username = &quot;myusername&quot;;\n    $password = &quot;mypassword&quot;;\n    $host = &quot;localhost&quot;;\n    $dbname = &quot;mydatabase&quot;;\n    \n     try{\n    	$db = new PDO(&quot;mysql:host={$host};dbname={$dbname};charset=utf8&quot;, $username, $password);\n    }\n    catch(PDOException $ex)\n    {\n    	die(&quot;Failed to connect to the database: &quot; . $ex-&gt;getMessage());\n    }'));
...
$id = DB::table('snippet_table')->insertGetId(array('title'=>'Subtraction of time by SQL','created_at'=>'2014-08-23 21:33:08','updated_at'=>'2014-08-23 21:33:08','content'=>'Get the records within 6 months. The &quot;180&quot; means 180 days\n     SELECT * FROM `mytable` WHERE DATEDIFF(NOW(),`created_at_col`) &lt; 180\n\n'));
